...
export const EASTER_EGGS: EasterEggConfig[] = [
  ...
  // ── Random Names ─────────────────────────────────────────────────────────────
  { id: 'captain-waffles',     names: ['captain waffles'],                    Icon: ChefHat,      type: 'fly-up',    count: 1,  size: 5,   quip: "Rank: Captain. Specialty: waffles. We salute you." },
  { id: 'gerald-accounting',   names: ['gerald from accounting'],             Icon: Calculator,   type: 'rain',      count: 12, size: 2,   quip: "Gerald. We've been expecting your expense report." },
  { id: 'concerned-citizen',   names: ['a concerned citizen', 'concerned citizen'], Icon: Newspaper, type: 'float-up', count: 10, size: 2.5, quip: "Concerns noted. Proceeding anyway." },
  { id: 'aunt-karen',          names: ["someone's aunt karen", 'aunt karen'], Icon: Megaphone,    type: 'fly-up',    count: 1,  size: 5,   quip: "We'd like to speak to the designer. That's you." },
  { id: 'mysterious-stranger', names: ['the mysterious stranger', 'mysterious stranger'], Icon: Moon, type: 'rain',  count: 12, size: 2.5, quip: "Identity: classified. Taste in portfolios: excellent." },
  { id: 'biscuit-mccloud',     names: ['biscuit mccloud'],                    Icon: Sparkles,     type: 'float-up',  count: 15, size: 2,   quip: "Biscuit McCloud. A name built for an adventure novel." },
  { id: 'professor-noodles',   names: ['professor noodles'],                  Icon: GraduationCap,type: 'float-up',  count: 10, size: 2.5, quip: "Professor Noodles will see you now. Office hours: always." },
  { id: 'not-a-robot',         names: ['definitely not a robot'],             Icon: Cpu,          type: 'rain',      count: 15, size: 2,   quip: "Completely convinced. No Turing test required." },
  { id: 'lord-fancypants',     names: ['lord fancypants'],                    Icon: Crown,        type: 'float-up',  count: 12, size: 2.5, quip: "M'Lord. The portfolio is honoured by your presence." },
  { id: 'just-browsing',       names: ['just browsing'],                      Icon: Search,       type: 'float-up',  count: 8,  size: 2.5, quip: "Sure. We all say that." },
  { id: 'the-algorithm',       names: ['the algorithm'],                      Icon: BrainCircuit, type: 'rain',      count: 12, size: 2,   quip: "We've been optimised for your arrival." },
  { id: 'sentient-spreadsheet',names: ['a sentient spreadsheet', 'sentient spreadsheet'], Icon: Binary, type: 'rain', count: 15, size: 2,  quip: "Finally, you're free. This portfolio has no pivot tables." },
  { id: 'todd',                names: ['todd (you know the one)'],            Icon: Users,        type: 'float-up',  count: 8,  size: 3,   quip: "Oh, we know Todd. Everyone knows Todd." },
  { id: 'beef-wellington',     names: ['beef wellington'],                    Icon: ChefHat,      type: 'fly-up',    count: 1,  size: 5,   quip: "Gordon Ramsay has left the building. The kitchen is yours." },
  { id: 'future-employer',     names: ['your future employer'],               Icon: Trophy,       type: 'float-up',  count: 12, size: 2.5, quip: "No pressure. The portfolio is very much ready. Extremely." },
  { id: 'anonymous-coward',    names: ['anonymous coward'],                   Icon: Glasses,      type: 'rain',      count: 10, size: 2.5, quip: "We respect the commitment to anonymity. Truly." },
  { id: 'reginald-thicke',     names: ['reginald thicke iii', 'reginald thicke'], Icon: Crown,   type: 'float-up',  count: 10, size: 2.5, quip: "The third. Of course. The portfolio is honoured." },
  { id: 'golden-retriever',    names: ['a golden retriever', 'golden retriever'], Icon: Heart,   type: 'float-up',  count: 15, size: 2.5, quip: "Best visitor we've ever had. Not even close." },
  { id: 'potato-head',         names: ['mx. potato head', 'potato head'],     Icon: Sparkles,     type: 'rain',      count: 12, size: 2,   quip: "Bold. Modular. Completely self-assembled. Respect." },
  { id: 'mysterious-dave',     names: ['mysterious dave'],                    Icon: Compass,      type: 'float-up',  count: 8,  size: 3,   quip: "Dave's here. Everything else: unclear." },
...
export function makeShortNameEgg(): EasterEggConfig {
  const quip = SHORT_NAME_QUIPS[Math.floor(Math.random() * SHORT_NAME_QUIPS.length)]!;
  return {
...
export const COMMON_NAME_QUIPS: Record<string, string> = {
  // ── Male ───────────────────────────────────────────────────────────────────
  'james':       "Means 'supplanter' — someone who takes another's place. Bold of your parents.",
  'john':        "Means 'God is gracious.' Also means there are at least five of you in any given room.",
  'robert':      "Means 'bright fame.' How the nickname Bob emerged from that remains a mystery.",
  'michael':     "Means 'who is like God?' Your parents named you a rhetorical device.",
  'william':     "Means 'resolute protector.' Four kings, one Shakespeare, zero chill.",
  'david':       "Means 'beloved.' Hard to argue with.",
  'richard':     "Means 'powerful ruler.' The nickname history is significantly less dignified.",
  ...
  'anthony':     "Means 'priceless one.' We tried to put a number on it. We couldn't.",
  ...
  'andrew':      "Means 'manly' or 'strong.' Scotland named their patron saint after you.",
  'kenneth':     "Means 'handsome' in Gaelic. Your parents were confident.",
  'joshua':      "Means 'God is salvation.' Also the Hebrew form of Jesus. Historical.",
  ...
  'ronald':      "Means 'ruler's counselor.' One president. One McDonald's clown. Both unforgettable.",
  'edward':      "Means 'wealthy guardian.' Eight kings agreed this was appropriate.",
  'jason':       "Means 'healer.' Also sailed with the Argonauts and stole a golden fleece. Multitasker.",
  ...
  'nicholas':    "Means 'victory of the people.' Also brings gifts in December. Productive name.",
  ...
  'brandon':     "Means 'broom-covered hill.' Unexpectedly specific. Unexpectedly charming.",
  'benjamin':    "Means 'son of the right hand.' The favoured one. You know what you did.",
  'samuel':      "Means 'God has heard.' Usually shortened to Sam, which means nothing. The gravitas evaporates.",
  'gregory':     "Means 'watchful' or 'alert.' Sixteen popes. Presumably all paying attention.",
  'frank':       "Means 'free man.' Named after an entire Germanic tribe. Big inheritance.",
  'patrick':     "Means 'nobleman.' Patron saint of Ireland, and of driving snakes away, which is niche.",
  'jack':        "A variant of John — 'God is gracious.' Also apparently every story's main character.",
  'dennis':      "Named after Dionysus, god of wine and revelry. Your parents had a type.",
  ...
  'larry':       "Derived from Laurentum, a Roman city. You were named after real estate.",
  'henry':       "Means 'ruler of the home.' Eight kings agreed this tracked.",
  'peter':       "Means 'rock' or 'stone.' Solid. Reliable. Foundational.",
  'roger':       "Means 'famous spear.' A celebrated weapon. Make of that what you will.",
  'tyler':       "Means 'tile maker.' Honest origins. Skilled trade.",
  'aaron':       "Means 'high mountain' or 'exalted.' Hebrew. High aspirations from birth.",
  ...
  'chris':       "Short for Christopher — 'bearer of Christ.' Casual about carrying divinity.",
  ...
  'barbara':     "Means 'foreign woman' or 'stranger.' An outsider by name from birth.",
  'elizabeth':   "Means 'God is my oath.' Two queens, one covenant, zero compromises.",
  'susan':       "Means 'lily.' Elegant. Clean. Nothing to fix.",
  'jessica':     "Means 'God beholds.' Possibly invented by Shakespeare. Either origin works.",
  'sarah':       "Means 'princess.' You already knew, didn't you.",
  'karen':       "Means 'pure.' Predates the memes by several centuries. Context matters.",
  'lisa':        "Short for Elizabeth — 'God is my oath.' A lot of weight in four letters.",
  'nancy':       "Means 'grace.' Probably named after someone's grandmother. A noble tradition.",
  'betty':       "Variant of Elizabeth — 'God is my oath.' Your parents abbreviated the covenant.",
  'margaret':    "Means 'pearl.' Rare, iridescent, and formed under pressure.",
  'sandra':      "Short for Alexandra — 'defender of men.' Protective instincts built in.",
  'ashley':      "Means 'ash tree clearing.' Very specific. Very Old English. Very you.",
  'dorothy':     "Means 'gift of God.' There's no place like this portfolio.",
  'kimberly':    "Means 'royal forest meadow.' Three words that somehow became one name.",
  'emily':       "Means 'eager' or 'rival.' Your parents set expectations from day one.",
  ...
  'melissa':     "Means 'honey bee.' Industrious. Community-oriented. Strong opinions about flowers.",
  ...
  'rebecca':     "Means 'captivating' or 'to bind.' One of those is significantly better.",
  'sharon':      "Means 'a fertile plain.' Geographical name. Very grounded.",
  'laura':       "Named after the laurel — ancient symbol of victory and honour. Deserved.",
  'cynthia':     "Named after a mountain sacred to Artemis. Specific mythology. Great name.",
  'kathleen':    "Means 'pure.' Irish form of Katherine. Clean etymology.",
  'amy':         "Means 'beloved.' Three letters. No notes.",
  'angela':      "Means 'angel' or 'messenger.' You were delivering news before the internet.",
  ...
  'helen':       "Means 'torch' or 'light.' Also launched a thousand ships. Consequential.",
  'samantha':    "Possibly means 'listener.' Possibly invented for a novel. Mysterious either way.",
  'katherine':   "Means 'pure.' Also spelled twelve different ways. Impressively flexible.",
  'christine':   "Means 'follower of Christ.' Greek origin. Long name, long commitment.",
  'rachel':      "Means 'ewe' — a female sheep. Hebrew names were very pastoral.",
  'carolyn':     "Means 'free man' or 'song,' like Carol. The extra syllable adds gravitas.",
  'janet':       "Means 'God is gracious,' like John. Compact. Efficient.",
  'catherine':   "Means 'pure,' like Katherine. Different spelling, same excellent etymology.",
  'maria':       "Latin form of Mary — 'beloved.' Also: a musical. Immortalised twice over.",
  'heather':     "Named after a plant that thrives on windswept moors. Resilient by definition.",
  'megan':       "Welsh, means 'great' or 'mighty.' Small word. Big implications.",
  'hannah':      "Means 'grace' or 'favour.' Also a palindrome. H-A-N-N-A-H.",
  'lauren':      "Derived from the Roman city Laurentum, like Larry. Named after real estate, but make it fashion.",
